...
__conda_setup="$('/Users/natelandau/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/natelandau/miniforge3/etc/profile.d/conda.sh" ]; then
        . "/Users/natelandau/miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/natelandau/miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<

# To customize prompt, run `p10k configure` or edit ~/dotfiles-private/dotfiles/shell/p10k.zsh.
[[ ! -f ~/dotfiles-private/dotfiles/shell/p10k.zsh ]] || source ~/dotfiles-private/dotfiles/shell/p10k.zsh
